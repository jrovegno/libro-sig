...
El color es la más importante de todas las variables visuales, debido a las posibilidades que ofrece\footnote{Si estas leyendo una copia impresa de este libro, en blanco y negro, te recomiendo acudir a la versión digital, donde encontraras las imágenes en colores.}.

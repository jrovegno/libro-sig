...
Las operaciones de edición pueden emplearse para la \textbf{creación de nueva cartografía} (como vimos en el capítulo \ref{Fuentes_datos}), así como para la \textbf{actualización} de esta. 
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=0.95\columnwidth]{Software/Servidores_y_clientes.pdf}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=.5\columnwidth]{Software/Esquema_no_interoperable.pdf}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=.5\columnwidth]{Software/Esquema_interoperable.pdf}

...
\begin{figure}[h]   
\centering
\includegraphics[width= .45\columnwidth]{Introduccion_procesos/Escalas_formas_terreno.pdf}
...
\begin{figure}[h]   
\centering
\includegraphics[width= .45\columnwidth]{Introduccion_procesos/Medida_linea_fractal.pdf}
...
\begin{figure}[!hbt]   
\centering
\includegraphics[width=\textwidth]{Introduccion_procesos/Autocorrelacion_espacial.png}
...
\begin{figure}[h]   
\centering
\includegraphics[width=.35\columnwidth]{Introduccion_procesos/Efecto_borde.pdf}
\caption{\small Representación del efecto borde y cómo este afecta en mayor o menor medida en función de la escala de análisis. Las zonas en trazo continuo no se ven afectadas. Las zonas en trazo punteado están afectadas de efecto de borde en diferente grado.}

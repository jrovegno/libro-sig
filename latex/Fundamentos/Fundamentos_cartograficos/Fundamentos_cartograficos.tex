...
Un tipo de datos particulares con los que se trabaja en un SIG, los datos \emph{ráster}, tienen a su vez un parámetro de resolución (el \textbf{tamaño de celda}) ligado a la escala. Veremos más al respecto en el capítulo \ref{Tipos_datos}.

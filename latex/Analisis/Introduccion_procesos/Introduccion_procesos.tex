...
\begin{figure}[h]   
\centering
\includegraphics[width= .45\columnwidth]{Analisis_espacial/Escalas_formas_terreno.pdf}
...
\begin{figure}[h]   
\centering
\includegraphics[width= .45\columnwidth]{Analisis_espacial/Medida_linea_fractal.pdf}
